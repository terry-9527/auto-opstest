...
IFontDisp = Font
__all__ = [ 'OLE_OPTEXCLUSIVE', 'Font', 'IPicture', 'FONTITALIC',
           'FontEvents', 'OLE_TRISTATE', 'OLE_COLOR', 'Picture',
           'IPictureDisp', 'FONTBOLD', 'OLE_XSIZE_CONTAINER',
           'OLE_CANCELBOOL', 'OLE_HANDLE', 'OLE_YSIZE_PIXELS',
           'StdFont', 'FONTSIZE', 'OLE_XSIZE_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'Checked', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'OLE_XPOS_PIXELS', 'Gray',
           'OLE_YPOS_PIXELS', 'OLE_XPOS_CONTAINER', 'Unchecked',
           'Default', 'IFont', 'OLE_ENABLEDEFAULTBOOL', 'Color',
           'FONTSTRIKETHROUGH', 'StdPicture', 'LoadPictureConstants',
           'IFontDisp', 'Monochrome', 'OLE_XPOS_HIMETRIC', 'VgaColor',
           'OLE_YSIZE_CONTAINER', 'FONTNAME', 'FONTUNDERSCORE',
           'IFontEventsDisp', 'OLE_YPOS_HIMETRIC']
from comtypes import _check_version; _check_version('1.1.11', 1247528633.4091063)
